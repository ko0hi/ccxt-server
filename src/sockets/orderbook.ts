...
const watchOrderBookThrottle = async (socket: Socket, exchange: Exchange, symbol: string, limit: number, interval: number) => {
...
const handleOrderbookSocket = async (socket: Socket, payload: {
    exchangeId: string;
    symbol: string,
    interval?: number,
    limit?: number
